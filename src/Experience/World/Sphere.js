...
export default class Sphere
{
    ...
    setVariations()
    {
        ...
        {
            const level0 = this.sound.levels[0] || 0
            const level1 = this.sound.levels[1] || 0
            const level2 = this.sound.levels[2] || 0
        ...
        {
            let value = this.sound.levels[0] || 0
            value *= 0.003
            value += 0.0001
        ...
        {
            let value = this.sound.levels[1] || 0
            value *= 2
            value += 3.587
        ...
        this.variations.highLevel.upEasing = 0.12
        this.variations.highLevel.downEasing = 0.031
        this.variations.highLevel.getValue = () =>
        {
            let value = this.sound.levels[2] || 0
            value *= 5
            value += 0.5
    ...
    setLights()
    {
        ...
        this.lights.a.color = {}
        this.lights.a.color.value = '#ff2100'
    ...
    setGeometry()
    {
        this.geometry = new THREE.SphereGeometry(0.9, 512, 512)
    ...
    setMaterial()
    {
        this.material = new THREE.ShaderMaterial({
            uniforms:
            {
                ...
                uDistortionFrequency: { value: 0.6 },
    ...
    update()
    {
        ...
        for(let _variationName in this.variations)
        {
            ...
            variation.target = this.sound.soundsCreated ? variation.getValue() : variation.getDefault()
        ...
        this.material.uniforms.uOffset.value.add(new THREE.Vector3(0, -0.01, 0))
